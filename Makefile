...
ACLOCAL = ${SHELL} /usr/src/bhati/freeswitch-1.10.7.-release/build/config/missing aclocal-1.13
AMQP_CFLAGS = 
AMQP_LIBS = 
AMRWB_CFLAGS = 
AMRWB_LIBS = 
...
AUTOCONF = ${SHELL} /usr/src/bhati/freeswitch-1.10.7.-release/build/config/missing autoconf
AUTOHEADER = ${SHELL} /usr/src/bhati/freeswitch-1.10.7.-release/build/config/missing autoheader
AUTOMAKE = ${SHELL} /usr/src/bhati/freeswitch-1.10.7.-release/build/config/missing automake-1.13
...
G7221_CFLAGS = 
G7221_LIBS = 
GETG729 = cd /usr/src/bhati/freeswitch-1.10.7.-release/libs && /bin/sh /usr/src/bhati/freeswitch-1.10.7/build/getg729.sh
GETLIB = cd /usr/src/bhati/freeswitch-1.10.7.-release/libs && /bin/sh /usr/src/bhati/freeswitch-1.10.7/build/getlib.sh
GETSOUNDS = /bin/sh /usr/src/bhati/freeswitch-1.10.7.-release/build/getsounds.sh
GREP = /usr/bin/grep
GUMBO_CFLAGS = 
GUMBO_LIBS = 
H2O_CFLAGS = 
...
MAGICK_CFLAGS = 
MAGICK_LIBS = 
MAKEINFO = ${SHELL} /usr/src/bhati/freeswitch-1.10.7.-release/build/config/missing makeinfo
MANIFEST_TOOL = :
MEMCACHED_CFLAGS =  
...
STRIP = strip
SWITCH_AM_CFLAGS = -I/usr/include/uuid   -I/usr/src/bhati/freeswitch-1.10.7.-release/src/include -I/usr/src/bhati/freeswitch-1.10.7.-release/src/include -I/usr/src/bhati/freeswitch-1.10.7.-release/libs/libteletone/src -fPIC -ffast-math -Werror -Wno-unused-result -fvisibility=hidden -DSWITCH_API_VISIBILITY=1 -DCJSON_API_VISIBILITY=1 -DHAVE_VISIBILITY=1 -g -ggdb -DHAVE_OPENSSL
SWITCH_AM_CPPFLAGS = -I/usr/src/bhati/freeswitch-1.10.7.-release/src/include -I/usr/src/bhati/freeswitch-1.10.7.-release/src/include -I/usr/src/bhati/freeswitch-1.10.7.-release/libs/libteletone/src
SWITCH_AM_CXXFLAGS = -I/usr/src/bhati/freeswitch-1.10.7.-release/src/include -I/usr/src/bhati/freeswitch-1.10.7.-release/src/include -I/usr/src/bhati/freeswitch-1.10.7/libs/libteletone/src -fPIC -ffast-math -fvisibility=hidden -DSWITCH_API_VISIBILITY=1 -DCJSON_API_VISIBILITY=1 -DHAVE_VISIBILITY=1
...
YAML_LIBS = 
ZCAT = /usr/bin/gunzip
abs_builddir = /usr/src/bhati/freeswitch-1.10.7.-release/src/mod/applications/mod_cc_pbx
abs_srcdir = /usr/src/bhati/freeswitch-1.10.7.-release/src/mod/applications/mod_cc_pbx
abs_top_builddir = /usr/src/bhati/freeswitch-1.10.7.-release
abs_top_srcdir = /usr/src/bhati/freeswitch-1.10.7.-release
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /usr/src/bhati/freeswitch-1.10.7.-release/build/config/install-sh
...
switch_builddir = /usr/src/bhati/freeswitch-1.10.7.-release
switch_srcdir = /usr/src/bhati/freeswitch-1.10.7.-release
