...
#define MAX 10
#define NULL ((void *)0)
//#define real_path "/home/cloudconnect/pbx_new/upload/def_prompts/"
...
// switch_status_t handle_call(switch_channel_t *channel, char *dsn, switch_mutex_t *mutex, char * path, call_details_t *call_info);
...
// cc_pbx_function
// char*  dialoutrule (switch_core_session_t *session, char *dsn, switch_mutex_t *mutex,call_details_t *call,const char * dial_num);
...
void bridge_call(switch_core_session_t *session, call_details_t *call, const char *dial_num, char *dsn, switch_mutex_t *mutex);
...
int handle_stcky_agnt(switch_channel_t *channel, char *dsn, switch_mutex_t *mutex, char *path, char *custom_path, call_details_t *call);
void handle_play_bck(switch_channel_t *channel, char *dsn, switch_mutex_t *mutex, char *path, char *custom_path, char *id);
// void handle_conf(switch_channel_t *channel,call_details_t *call,char * dsn,switch_mutex_t *mutex);
